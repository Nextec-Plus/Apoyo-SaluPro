...
/**
 * GET /api/reportes/ingresos-hoy/export?format=csv|pdf
 *
 * Descarga ingresos del día (hora Venezuela) en CSV o PDF.
 */
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const payload = await buildIngresosHoyPayload(organization_id, supabase);
